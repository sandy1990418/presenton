...
async def get_all_presentations(sql_session: AsyncSession = Depends(get_async_session)):
    ...
    presentations_with_slides = [
        PresentationWithSlides(
            **{**presentation.model_dump(), "id": str(presentation.id)},
            slides=[first_slide],
        )
...
async def update_presentation(
    ...
    if slides:
        ...
        for slide in slides:
            slide.presentation = uuid.UUID(slide.presentation) if isinstance(slide.presentation, str) else slide.presentation
